...
const products = [
  ...
  { id: 2, name: 'Khamrah by Lattafa', category: 'Arabian perfumes', badge: 'Popular',
    ...
    images: ['/images/Khamrah.jpg', '/images/Khamrah_Waha.jpg', '/images/Khamrah_Dukhan.jpg', '/images/Khamrah_Qahwa.jpg'],
    price: 45000,
    variants: [
      ...
      { name: 'Khamrah Qahwa', price: 45000, image: '/images/Khamrah_Qahwa.jpg' }
    ] },
  ...
  { id: 6, name: 'Mousuf Perfume Oil Set (4-piece)', category: 'Giftset/box', badge: 'Luxury Gift',
    ...
    images: ['/images/Mousuf_4in1.jpg'], price: 20000, variants: [] },
  ...
  { id: 7, name: '9am by Afnan', category: 'Designer perfumes', badge: 'New',
    ...
    images: ['/images/9am_by_Afnan.jpg'], price: 55000, variants: [] },

  { id: 8, name: '9pm by Afnan', category: 'Arabian perfumes', badge: 'Popular',
    ...
    images: ['/images/9pm_by_Afnan.jpg'], price: 55000, variants: [] },
  ...
  { id: 9, name: '9am Dive by Afnan', category: 'Designer perfumes', badge: 'New',
    ...
    images: ['/images/9am_Diva_by_Afnan.jpg'], price: 52000, variants: [] },
  ...
  { id: 10, name: '9pm Elixir (Mini) by Afnan', category: 'Mini perfumes', badge: 'New',
    ...
    images: ['/images/9pm_Elixir__Mini_.jpg'], price: 6000, variants: [] },
  ...
  { id: 11, name: '9pm Pour Femme by Afnan', category: 'Designer perfumes', badge: 'New',
    ...
    images: ['/images/9pm_Pour_Femme_by_Afnan.jpg'], price: 52000, variants: [] },
  ...
  { id: 12, name: '24K White', category: 'Designer perfumes', badge: 'New',
    ...
    images: ['/images/24K_white.jpg'], price: 20000, variants: [] },
  ...
  { id: 13, name: "Bade'e Al Oud Gift Set by Lattafa", category: 'Giftset/box', badge: 'Luxury Gift',
    ...
    images: ['/images/Bade_e_Al_Oud.jpg'], price: 35000, variants: [] },
  ...
  { id: 15, name: 'Club de Nuit Iconic by Armaf', category: 'Designer perfumes', badge: 'Popular',
    ...
    images: ['/images/Club_de_Nuit_Iconic.jpg'], price: 28000, variants: [] },
  ...
  { id: 16, name: 'Club de Nuit Intense Man by Armaf', category: 'Designer perfumes', badge: 'Best Seller',
    ...
    images: ['/images/Club_De_Nuit_Intense_Man.jpg'], price: 26000, variants: [] },
  ...
  { id: 17, name: 'Lasgidi Body Mist', category: 'Body mists/spray', badge: 'Fresh',
    ...
    images: ['/images/Lasgidi_Body_mist.jpg'], price: 4000,
    variants: [
      { name: 'Juicy Crush', price: 4000, image: '/images/Lasgidi_Body_mist.jpg' },
      { name: 'Gelato Crush', price: 4000, image: '/images/Lasgidi_Body_mist.jpg' },
      { name: 'Vanilla Crush', price: 4000, image: '/images/Lasgidi_Body_mist.jpg' },
      { name: 'Pinky Crush', price: 4000, image: '/images/Lasgidi_Body_mist.jpg' },
      { name: 'Candy Crush', price: 4000, image: '/images/Lasgidi_Body_mist.jpg' },
      { name: 'Pistachio Crush', price: 4000, image: '/images/Lasgidi_Body_mist.jpg' }
    ] },
  ...
  { id: 19, name: 'Matelot Gift Set', category: 'Giftset/box', badge: 'Luxury Gift',
    ...
    images: ['/images/Matelot_gift_set.jpg'], price: 22000, variants: [] },
  ...
  { id: 20, name: 'Hayaati Women by Ard Al Zaafaran', category: 'Arabian perfumes', badge: 'New',
    ...
    images: ['/images/Oud_Al_layl.jpg'], price: 22000,
    variants: [
      { name: 'Oud Al Layl', price: 22000, image: '/images/Oud_Al_layl.jpg' },
      { name: 'Oud Al Layl Midnight Edition', price: 24000, image: '/images/Oud_Al_layl.jpg' }
    ] },
  ...
  { id: 22, name: 'Oud Mood Perfume Set (3-in-1)', category: 'Giftset/box', badge: 'Luxury Gift',
    ...
    images: ['/images/Oud_mood_3in1.jpg'], price: 20000, variants: [] },
  ...
  { id: 23, name: 'Pocket Perfumes Collection', category: 'Mini perfumes', badge: 'Fresh',
    ...
    images: ['/images/Pocket_perfumes.jpg'], price: 1700,
    variants: [
      { name: 'Sultan Al Quloob', price: 1700, image: '/images/Pocket_perfumes.jpg' },
      { name: 'Washwashah', price: 1700, image: '/images/Pocket_perfumes.jpg' },
      { name: 'Kashka Crystal', price: 1700, image: '/images/Pocket_perfumes.jpg' }
    ] },
  ...
  { id: 24, name: 'Qaed Al Fursan by Lattafa', category: 'Arabian perfumes', badge: 'Popular',
    ...
    images: ['/images/Qa_ed_Al_Fursan.jpg'], price: 25000, variants: [] },
  ...
  { id: 25, name: 'Ramz Gold by Lattafa', category: 'Arabian perfumes', badge: 'New',
    ...
    images: ['/images/Ramz_Gold_by_Lattafa.jpg'], price: 20000, variants: [] },
  ...
  { id: 26, name: 'Riggs London Body Mist', category: 'Body mists/spray', badge: 'Fresh',
    ...
    images: ['/images/Riggs_body_mist.jpg'], price: 5000,
    variants: [
      { name: 'West', price: 5000, image: '/images/Riggs_body_mist.jpg' },
      { name: 'Pink', price: 5000, image: '/images/Riggs_body_mist.jpg' },
      { name: 'Dynamo', price: 5000, image: '/images/Riggs_body_mist.jpg' }
    ] },
  ...
  { id: 27, name: 'Smart Collection Perfume', category: 'Mini perfumes', badge: 'Luxury Gift',
    ...
    images: ['/images/Smart_collection__Mini_.JPG'], price: 5000, variants: [] },
  ...
  { id: 28, name: 'Veyes Perfume Gift Box (4-in-1)', category: 'Giftset/box', badge: 'Luxury Gift',
    ...
    images: ['/images/Veyes_gift_box.jpg'], price: 20000, variants: [] },
  ...
  { id: 29, name: "Victoria's Secret Fragrance Mist", category: 'Body mists/spray', badge: 'Popular',
    ...
    images: ['/images/Victoria_Secret_body_mist.jpg'], price: 6000, variants: [] },
  ...
  { id: 30, name: 'Vintage Radio Mini by HNN', category: 'Mini perfumes', badge: 'New',
    ...
    images: ['/images/Vintage_Radio__Mini_.jpg'], price: 7000,
    variants: [
      { name: 'Vintage Radio Lamanda', price: 7000, image: '/images/Vintage_Radio__Mini_.jpg' },
      { name: 'Vintage Radio Classic', price: 7000, image: '/images/Vintage_Radio__Mini_.jpg' }
    ] }
  ];
